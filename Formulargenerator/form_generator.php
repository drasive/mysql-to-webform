...
<body>
    ...
    <div class="container">
        <div class="col-xs-4 col-sm-6 col-md-6 col-lg-6">
            ...
            <p class="lead">
                Der Formular-Generator unterstützt Sie in Ihrer Aufgabe Nutzereingaben für Ihre Datenbank zu erfassen.                
            </p>
            <p class="lead">
                Geben Sie einfach die erforderlichen Informationen ein und klicken Sie auf "Formular generieren".
            </p>
            <p class="lead">
